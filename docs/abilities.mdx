...
short_title: Abilities API
description: Interfaces and Loader integration for WordPress Abilities.
---

import { Code } from '@astrojs/starlight/components';

const dataRetrievalCode = String.raw`<?php
...
const myAbilityCode = String.raw`<?php
...
const registerAbilityCode = String.raw`$this->loader->add_ability( Abilities\My_Ability::class );`;
...
<Code code={dataRetrievalCode} lang="php" title="src/Abilities/Categories/Data_Retrieval.php" />

### 2. Create Ability Class

Create `src/Abilities/My_Ability.php`:

<Code code={myAbilityCode} lang="php" title="src/Abilities/My_Ability.php" />

### 3. Register Ability

In `Demo_Plugin.php`:

<Code code={registerAbilityCode} lang="php" title="src/Demo_Plugin.php" />
