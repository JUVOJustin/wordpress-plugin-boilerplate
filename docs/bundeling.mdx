...
const entrypointsCode = String.raw`entry: {
...
const newEntrypointCode = String.raw`entry: {
    // ... existing entries
    'my-new-feature': [
...
const copyPluginCode = String.raw`const CopyPlugin = require('copy-webpack-plugin');
...
const enqueueEntrypointSignatureCode = String.raw`private function enqueue_entrypoint( string $entry, array $localize_data = array() ): void`;
...
<Code code={entrypointsCode} lang="js" title="webpack.config.js" />
...
<Code code={newEntrypointCode} lang="js" title="webpack.config.js" />
...
<Code code={copyPluginCode} lang="js" title="webpack.config.js" />
...
<Code code={enqueueEntrypointSignatureCode} lang="php" title="src/Demo_Plugin.php" />
