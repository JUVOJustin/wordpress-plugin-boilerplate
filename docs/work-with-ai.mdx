...
:::tip[Missing "plugin-translations-update" skill?]
You can install the skill using `npx skills add JUVOJustin/wordpress-plugin-boilerplate --skill plugin-translations-update`
:::
...
:::tip[Missing "boilerplate-update" skill?]
You can install the skill using `npx skills add JUVOJustin/wordpress-plugin-boilerplate --skill boilerplate-update`
:::
