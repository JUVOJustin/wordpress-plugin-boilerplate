---
title: Develop and Ship Blocks
short_title: Blocks
description: Block scaffolding and automatic registration workflow.
---

import { Code } from '@astrojs/starlight/components';

const editorEntrypointCode = String.raw`/**
...
<Code code={editorEntrypointCode} lang="php" title="src/Demo_Plugin.php" />
