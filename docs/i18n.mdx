...
:::note
The i18n Composer scripts assume that `wp i18n` is available in the current environment. If you run the commands outside `wp-env`, install WP-CLI separately and add the required packages yourself. See the [official WP-CLI installation guide](https://make.wordpress.org/cli/handbook/guides/installing/).
:::
