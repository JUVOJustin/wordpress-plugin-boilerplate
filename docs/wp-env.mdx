...
const wpEnvHostScriptCode = String.raw`{
  "scripts": {
...
const wpEnvContainerScriptCode = String.raw`{
  "scripts": {
...
<Code code={wpEnvHostScriptCode} lang="json" title="package.json" />
...
<Code code={wpEnvContainerScriptCode} lang="json" title="composer.json" />
