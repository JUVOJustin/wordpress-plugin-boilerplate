...
const AREAS = [
	{
		...
		confirmation: false,
		refs: ['references/i18n.mdx', 'references/bundeling.mdx'],
	...
	},
	{
		...
		title: 'JS & bundling',
		confirmation: false,
		refs: ['references/bundeling.mdx', 'references/wp-env.mdx', 'references/create-blocks.mdx'],
	...
	},
	{
		...
		confirmation: true,
		refs: ['references/github-actions.mdx'],
