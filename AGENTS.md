...
- **APM source layout**: Keep all authored package primitives under `.apm/`. Never commit a `.agents/` directory; agent-specific deployment paths are generated by APM in consumer projects.
