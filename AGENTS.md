...
- Keep portable foundation rules in `.apm/instructions/`; do not duplicate them in this producer-only section.
- Keep task workflows, references, and deterministic helper scripts in `.apm/skills/wp-plugin-bp/`.
